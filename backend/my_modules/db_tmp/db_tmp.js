...
module.exports = {
    ...
    db_deleteSprintsForProjectId(id_project) {
        let finish = false;
    ...
    db_updateTasksTime(tasks_in_doing) {
    ...
    db_moveRightTask(id_task, id_sprint) {
    ...
    db_deleteTasksForSprintId(id_sprint) {
        let finish = false;
    ...
    db_deleteTasksForProjectId(id_project) {
        let finish = false;
